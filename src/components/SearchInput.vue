<template>
  <div class="relative">
    ...
    <div class="relative w-80">
      <input
        type="text"
        placeholder="Search (Press forward slash to focus)"
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-indigo-500 w-80"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
