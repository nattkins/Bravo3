...
<section>
   ...
   <g-link to="/#reachout"> <button class="block bg-indigo-500 hover:bg-gold-600 text-white text-sm font-semibold tracking-wide uppercase shadow rounded cursor-pointer px-6 py-3">Contact Us</button></g-link>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src="../../static/pass-the-honey-vZGvVTO1pIg-unsplash.jpg">
    </div>
  </div>
</section>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font">Solutions</h1>
    </div>
...
<section class="text-gray-700 body-font border-t border-gray-200">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 id="projects" class="sm:text-3xl text-2xl font-medium title-font mb-2">Projects </h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-base">At Bravo Criteria working remotely is our everyday, so one of the few benefits of covid-19, for us, is that we don't have to explain the benefits of this way of working to anyone anymore ever.</p>
                  <g-image class="object-cover object-center rounded" width="500" alt="hero" src="../../static/worldp.png" />
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">New York - London - Melbourne</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">London - Munich - Madrid</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">Global</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">London - Bucharest</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">Melbourne - London</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg  font-medium title-font mb-2">London - Hong Kong</h2>
...
<section class="text-gray-700 body-font border-t border-gray-200">
  <div id="team" class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4" >Our Team </h1>
