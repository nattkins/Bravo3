    ...
    <header class="border-t-14 border-gold-500">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#reachout" v-scroll-to="'#reachout'" class="text-copy-primary hover:text-gray-600">Contact</a>
    ...
    <footer class="bg-gold-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:neville@bravocriteria.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.youtube.com/watch?v=kuEBP4bkUik" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/nattkins" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/nevillea" target="_blank" class="text-white hover:text-gray-400">
